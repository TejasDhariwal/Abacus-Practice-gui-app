...
class Func():
    ...
    def calculationQuestions():
        # This function will always display 5 random questions of calculation. 
    ...
    def oralMultiplicationQuestions():
        ...
        heading5 = customtkinter.CTkLabel(frame4, text="Multiplication :-", font=("Dosis", 20))
        heading5.place(x=10, y=10)

        oral_multiplication_question_btn = customtkinter.CTkButton(frame4, text="Start", width=80, font=("Dosis", 15), command=Func.oralMultiplicationQuestions)
        ...
        for i in range(1, 7):
            ...
            oral_questionLabel1 = customtkinter.CTkLabel(frame4, text=oral_mquestion, font=("Dosis", 20))
            oral_questionLabel1.place(x=50, y=60+a)

            oral_answerLabel1 = customtkinter.CTkLabel(frame4, text=str(oral_manswer), font=("Dosis", 20))
    ...
    def oralDivisionQuestions():
        ...
        # creating the same the widgets again as they are destroyed.
        heading6 = customtkinter.CTkLabel(frame5, text="Division :-", font=("Dosis", 20))
        heading6.place(x=10, y=10)

        oral_division_question_btn = customtkinter.CTkButton(frame5, text="Start", font=("Dosis", 15), width=80, command=Func.oralDivisionQuestions)
        ...
        for j in range(1, 7):
            ...
            oral_questionLabel2 = customtkinter.CTkLabel(frame5, text=complete_oral_dquestion, font=("Dosis", 20))
            oral_questionLabel2.place(x=50, y=60+b)

            oral_answerLabel2 = customtkinter.CTkLabel(frame5, text=str(oral_danswer), font=("Dosis", 20))
    ...
    def oralCalculationQuestions():
        ...
        # creating the same the widgets again as they are destroyed.
        heading7 = customtkinter.CTkLabel(frame6, text="Calculation :-", font=("Dosis", 20))
        heading7.place(x=10, y=10)

        oral_calculation_question_btn = customtkinter.CTkButton(frame6, text="Start", font=("Dosis", 15), width=80, command=Func.oralCalculationQuestions)
        ...
        for e in range(1, 6):
            ...
            for f in range(1, 6):
                ...
                oral_questionLabel3 = customtkinter.CTkLabel(frame6, text=complete_oral_cquestion_value, font=("Dosis", 20))
            ...
            # displaying the answer
            oral_answerLabel3 = customtkinter.CTkLabel(frame6, text=str(answer), font=("Dosis", 20))
...
tab1 = customtkinter.CTkTabview(root, width=980, height=680)
...
# Appearance
customize_frame1 = customtkinter.CTkFrame(tab1.tab('Settings'), width=940, height=100)
...
customize_frame2 = customtkinter.CTkFrame(tab1.tab('Settings'), width=940, height=200)
...
customize_frame3 = customtkinter.CTkFrame(tab1.tab('Settings'), width=940, height=300)
...
heading4.place(x=370, y=10)

# oral multiplication questions
frame4 = customtkinter.CTkFrame(tab1.tab("Oral Worksheet"), width=380, height=280)
...
frame6 = customtkinter.CTkFrame(tab1.tab("Oral Worksheet"), width=770, height=260)
frame6.place(x=80, y=340)
